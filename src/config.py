...
# Features for the game-level HOME RUN projection model. Chosen because
# they are exactly the HR-relevant signals: park HR factor, lineup
# power, pitcher contact suppression, and HR-friendly weather. All
# columns already exist in the features CSV — no rebuild required.
# Like every model here, it only gets a display slot if it beats its
# baseline (always predict the average HRs per game).
HR_FEATURE_COLUMNS = [
    "hr_park_factor",
    "home_team_hr_rate",
    "away_team_hr_rate",
